...
import FunctionalModulesStackImage from './FunctionalModulesStackImage';

export default function FunctionalModal({ pageName }) {
    ...
    return (
        <div className="project__domains functionalModal">
            <Container>
                <Row>
                    <Col lg={12} md={12} sm={12} >
                        <GlobalHeadingHardCoded strong={`Functional`} span={`Modules`} />
                    </Col>
                </Row>
                <Row>
                    <Col lg={12} md={12} sm={12} >
                                        ...
                                        return (
                                            <li key={i}>
                                                <a href="/#" onClick={handelClick}>
                                                    <FunctionalModulesStackImage className={`stack`} imgUrl={localDomain + domain.image} imgTitle={domain.title}>
                                                        {domain.title}
                                                    </FunctionalModulesStackImage>
                                                </a>
                                            </li>
                                        )
                                    })
